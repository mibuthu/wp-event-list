<?php
	$options_helptexts = array(
		'el_categories'         => array('label'   => __('Event Categories','eventlist'),
		                                 'caption' => '',
		                                 'desc'    => __('This option specifies all event category data.','eventlist')),

		'el_sync_cats'          => array('label'   => __('Sync Categories','eventlist'),
		...
		'el_no_event_text'      => array('label'   => __('Text for no events','eventlist'),
		                                 'caption' => '',
		                                 'desc'    => __('This option defines the text which is displayed if no events are available for the selected view.','eventlist')),

		'el_date_once_per_day'  => array('label'   => __('Date display','eventlist'),
		...
		'el_html_tags_in_time'  => array('label'   => __('HTML tags','eventlist'),
		...
		'el_html_tags_in_loc'   => array('label'   => '',
		...
		'el_edit_dateformat'    => array('label'   => __('Date format in edit form','eventlist'),
		...
		'el_enable_feed'        => array('label'   => __('Enable RSS feed','eventlist'),
		...
		'el_feed_name'          => array('label'   => __('Feed name','eventlist'),
		...
		'el_feed_description'   => array('label'   => __('Feed Description','eventlist'),
		...
		'el_feed_upcoming_only' => array('label'   => __('Listed events','eventlist'),
		...
		'el_head_feed_link'     => array('label'   => __('Add RSS feed link in head','eventlist'),
		...
		'el_feed_link_pos'      => array('label'   => __('Position of the RSS feed link','eventlist'),
		...
		'el_feed_link_align'   => array('label'   => __('Align of the RSS feed link','eventlist'),
		...
		'el_feed_link_text'    => array('label'   => __('Feed link text','eventlist'),
		...
		'el_feed_link_img'     => array('label'   => __('Feed link image','eventlist'),
